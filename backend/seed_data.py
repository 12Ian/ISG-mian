...
_DEFAULT_ALGORITHMS = (
    ...
    },
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "required": False,
                "default_value": True,
                "description": "每条样本随机调整频率上下限；关闭时固定参数只生成一条",
            },
            {
    ...
    },
    {
        ...
        "parameters": [
            ...
            {
                "name": "mix_strategy", "options": ["avg", "max", "min", "random_weight"],
                "label": "混合策略",
                "type": "string",
                "required": False,
                "default_value": "avg",
                "options_json": ["avg", "max", "min", "random_weight"],
                "description": "多声道混合策略",
            },
            {
                "name": "dither",
    ...
    },
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "required": False,
                "default_value": True,
                "description": "开启后每条样本随机调整截止频率；关闭时固定参数只生成一条",
            },
            {
                "name": "max_variants_per_source",
                "label": "单源最大变体数",
    ...
    },
    {
        ...
        "callable_name": "run",
        "description": "按完整词语、短语及上下文搭配约束进行同词性替换增强",
        "input_contract": {
            "dataset_required": True,
            "sample_required": True,
            "fields": ["sample_path", "parameters", "output_dir"],
        ...
        "parameters": [
            ...
            },
            {
                ...
                "required": False,
                "default_value": None,
                "description": "可选 adjective、verb、noun、conjunction，留空表示不限制",
            },
            {
                "name": "phrase_level",
                "label": "短语级替换",
    ...
    },
    {
        ...
        "callable_name": "run",
        "description": "通过受控词语级删除、插入、交换模拟轻量文本噪声和输入错误",
        "input_contract": {
            "dataset_required": True,
            "sample_required": True,
            "fields": ["sample_path", "parameters", "output_dir"],
        ...
        "parameters": [
            {
                ...
                "required": False,
                "default_value": 0.1,
                "description": "受控词语级噪声扰动强度",
            },
            {
                "name": "deletion_probability", "label": "删除概率", "type": "number",
                "required": False, "default_value": 0.02, "description": "删除完整词语单元的基础概率",
            },
            {
                "name": "swap_probability", "label": "交换概率", "type": "number",
                "required": False, "default_value": 0.03, "description": "交换相邻词语单元的基础概率",
            },
            {
                "name": "insertion_probability", "label": "插入概率", "type": "number",
                "required": False, "default_value": 0.02, "description": "插入邻近或形近内容的基础概率",
            },
        ],
    },
    {
        ...
        "parameters": [
            ...
            },
            {
                ...
                "options": ["formal", "natural", "concise"],
                "description": "上下文连接语体: formal(正式), natural(自然), concise(简洁)",
            },
        ],
    },
    {
