...
DEFAULT_ALGORITHMS = (
    ...
    },
    {
        ...
        "callable_name": "run",
        "description": "使用Laplacian方差检测模糊图像，通过反锐化掩模进行去模糊处理",
        "input_contract": {"dataset_required": True, "sample_required": True},
        "output_contract": {"produces": ["suggestions"], "artifact_types": ["image"]},
        "parameters": [
            {
                "name": "blur_threshold",
                "label": "模糊阈值",
    ...
    },
    {
        ...
        "callable_name": "run",
        "description": "通过中值滤波差异估计噪声强度，使用fastNlMeansDenoisingColored进行去噪",
        "input_contract": {"dataset_required": True, "sample_required": True},
        "output_contract": {"produces": ["suggestions"], "artifact_types": ["image"]},
        "parameters": [
            {
    ...
    },
    {
        ...
        "callable_name": "run",
        "description": "模拟传感器噪声(散粒/读出)、模糊及下采样效果",
        "input_contract": {
            "dataset_required": True,
            "sample_required": True,
            "fields": ["sample_path", "parameters", "output_dir"],
