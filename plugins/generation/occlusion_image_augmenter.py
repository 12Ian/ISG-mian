...
def run(payload: dict, context) -> dict:
    ...
    mode = str(parameters.get("mode", parameters.get("遮挡类型", "random_erasing")) or "random_erasing")
    fill_mode = str(parameters.get("fill_mode", parameters.get("填充值模式", "mean")) or "mean")
    ...
    for index in range(target_count):
        ...
        outputs.append({
            ...
            "metadata": {
                ...
                "parameters": {"mode": mode, "fill_mode": fill_mode},
            },
            "status": "created",
        })
