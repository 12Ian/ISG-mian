                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                Text { text: root.isCompleted ? "正在加载生成结果" : "等待生成任务启动"; color: root.textMuted; font.pixelSize: 14; font.bold: true; Layout.alignment: Qt.AlignHCenter }
                            }
                            ListView {
                                id: taskMonitorList
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Text { text: "正在加载生成结果"; color: root.textMuted; font.pixelSize: 14; font.bold: true; Layout.alignment: Qt.AlignHCenter }
                        }
                        ListView {
